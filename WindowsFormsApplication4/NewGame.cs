            ...
            if (wallLength >= 9)
            {
                ...
                if (wallLength >= 16)
                {
                    ...
                    if (wallLength >= 25)
                    {
                        ...
                        gridSize = 25;
>>>>>>> 848626f6cfe74b8204f8ba9d17ceb0db66a9c1d7
...
<<<<<<< HEAD
        ...
        {
            //change for diffrent computer -wip-
            string begingPath = @"\\adfsstud2\R-U\tjl96\projects\TheseusAndTheMinotaur\WindowsFormsApplication4\";
        ...
        //    lblScore.Text = MultiArray[1,6].ToString();
